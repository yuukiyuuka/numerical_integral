program integral_trapezoid_prog
  implicit none
 ...
 !menghitung nilai integral numerik trapezoid
...
open(unit=2, file='output_integral_komp_trapezoid.txt', status='replace', action='write')
...
end program integral_trapezoid_prog
